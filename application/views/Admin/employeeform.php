               ...
               <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-6 b-r">
                                    ...
                                    <div class="form-group"><label>Name</label> <input type="text" placeholder="Enter employee name.." class="form-control"></div>
                                     
                                    <div class="form-group" id="data_3">
                                <label class="font-noraml">Joining Date</label>
                                ...
                                <div class="col-sm-6 b-r">
                                 <div><label>Role</label><select class="form-control m-b" name="role">
                                        <option>Select role...</option>
                                        <option>option 2</option>
                                        <option>option 3</option>
                                        <option>option 4</option>
                                    </select>   </div>
                                          <div class="form-group"><label>Salary</label> <input type="text" placeholder="salary.." class="form-control"></div>  
                                     
                                     <div>
                                       <p class="text-muted text-center"><small>----------or----------</small></p>
                                       <button type="submit" class="btn btn-sm btn-white btn-block" style="width:30%;margin-left:35%">Add new role</button>
                                    </div>
                                </div>
